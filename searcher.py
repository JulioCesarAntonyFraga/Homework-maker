...
waring = Label(text='Cuidado, as respostas são retiradas do google, portanto NÃO são 100% precisas')
waring.pack()
...
tuto = Label(text='Lembre-se, as perguntas tem que estar num documento .txt e organizadas como na imagem acima, ou o programa pode não funcionar corretamente!')
tuto.pack()
